...
function hintContainer(Input) {
  var HintedInput = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      var _this$props2 = this.props,
          ...
          props = (0, _objectWithoutPropertiesLoose2["default"])(_this$props2, ["forwardedRef", "hintText", "initialItem", "inputNode", "onAdd", "selectHintOnEnter", "highlightFirstResult", "isMenuShown", "minLength", "activeIndex"]);
  ...
  var HintedInputWithContext = (0, _Context.withContext)(HintedInput, ['hintText', 'initialItem', 'inputNode', 'onAdd', 'selectHintOnEnter', 'highlightFirstResult', 'isMenuShown', 'minLength', 'activeIndex']);
