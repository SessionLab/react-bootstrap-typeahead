...
function getInitialState(props) {
  var defaultInputValue = props.defaultInputValue,
      ...
      highlightFirstResult = props.highlightFirstResult;
  ...
  function Typeahead() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_handleSelectionAdd", function (option) {
      ...
      var _this$state = _this.state,
          ...
          initialItem = _this$state.initialItem;
      var selected;
      var selection = option;
      var text; // prevent initialItem to be selected when selecting others

      var hasInitialItemSelected = activeIndex > 0 && (0, _fastDeepEqual["default"])(selection, initialItem);
